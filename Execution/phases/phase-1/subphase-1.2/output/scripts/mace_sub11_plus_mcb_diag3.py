...
def main() -> int:
    ...
    try:
        ...
        # === MCB DIAG3 injection 2026-04-19 ===
        barostat_mcb = MonteCarloBarostat(
            1.0 * unit.atmosphere,
            300.0 * unit.kelvin,
            25,
        )
        hybrid_system.addForce(barostat_mcb)
        log(f'  [diag3] Added MonteCarloBarostat; force count now {hybrid_system.getNumForces()}')
